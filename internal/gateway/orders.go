...
func (o *OrderRoutes) Mount(mux *http.ServeMux) {
	...
	cl := o.client
	mux.HandleFunc("POST /v1/orders", route(c, br,
	...
	mux.HandleFunc("POST /v1/orders/{id}/cancel", byID(c, br,
	...
	mux.HandleFunc("POST /v1/orders/{id}/fulfill", byID(c, br,
...
func byID[P proto.Message](c *Core, br *circuitbreaker.Breaker, mk func() P, call func(context.Context, P) (proto.Message, error)) http.HandlerFunc {
...
func (o *OrderRoutes) get(w http.ResponseWriter, r *http.Request) {
	...
	o.core.invoke(w, r, o.core.OrderBreaker, func(ctx context.Context) (proto.Message, error) {
